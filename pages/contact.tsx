        ...
        <div className="bg-slate-50 dark:bg-slate-800/50">
          <div className="px-4 sm:px-6 py-16 sm:py-20">
            <div className="max-w-2xl mx-auto lg:max-w-4xl xl:max-w-5xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {contactMethods.map((method, index) => (
                  <a
                    ...
                    className="group p-6 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
                  >
              ...
              <div className="mt-12 p-8 rounded-3xl bg-gradient-to-br from-emerald-500 to-teal-600 text-center shadow-xl">
                <h3 className="text-2xl sm:text-3xl font-black text-white mb-3">
                  Prefer a Quick Chat?
                </h3>
                <p className="text-emerald-100 mb-6 max-w-lg mx-auto">
                  WhatsApp is the fastest way to reach me. I usually respond
                  within a few hours.
                </p>
                <a
                  href="https://wa.me/6285693380123?text=Hi%20Dedi,%20I'm%20interested%20in%20discussing%20a%20project%20with%20you."
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-white text-emerald-600 font-bold text-lg hover:bg-emerald-50 transition-colors shadow-lg"
                >
                  <svg
                    className="w-6 h-6"
                    fill="currentColor"
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-fuchsia-500 focus:border-transparent transition-all"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-fuchsia-500 focus:border-transparent transition-all resize-none"
                    ...
                    <button
                      ...
                      className="w-full px-8 py-4 rounded-xl bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold text-base hover:bg-slate-800 dark:hover:bg-slate-100 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 flex items-center justify-center gap-2"
                    >
                      {isSubmitting ? (
                        <>
                          <svg
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {faqs.map((faq, index) => (
                      <div
                        key={index}
                        className="rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 overflow-hidden"
                      >
                        <button
                          onClick={() =>
          ...
          <div className="px-4 sm:px-6 py-16 sm:py-20">
            <div className="max-w-2xl mx-auto lg:max-w-4xl xl:max-w-5xl">
              <div className="p-8 sm:p-12 rounded-3xl bg-slate-900 dark:bg-slate-800 text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-fuchsia-500 text-white mb-6">
                  <svg
                    className="w-8 h-8"
                    fill="none"
                    viewBox="0 0 24 24"
                ...
                <div className="flex flex-wrap justify-center gap-4 text-sm">
                  <span className="px-4 py-2 rounded-full bg-slate-800 dark:bg-slate-700 text-slate-300">
                    🌏 GMT+7 (WIB)
                  </span>
                  <span className="px-4 py-2 rounded-full bg-slate-800 dark:bg-slate-700 text-slate-300">
                    🌐 Remote Friendly

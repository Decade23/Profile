      ...
      <section id="profile" className="relative pb-20">
        <div className="container mb-5">
          <div className={`relative rounded-2xl overflow-hidden mb-5 w-full h-96 ${loading ? 'grayscale blur-2xl scale-110' : 'grayscale-0 blur-0 scale-100'}`}>
            <Image alt="Dedi Fardiyanto" src="/assets/images/dedi.png" placeholder="blur" blurDataURL="/assets/images/dedi.png" quality={loading ? 10 : 70} priority onLoadingComplete={() => setLoading(false)} layout="fill" objectFit="contain" />
          </div>

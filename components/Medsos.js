...
export default function Medsos() {
  ...
  return (
    <div className="relative mb-5">
      <h5 className="container mb-2 font-medium tracking-widest">Medsos</h5>

      <div className="container relative flex flex-row flex-wrap items-center">
        {medsos.length > 0 &&
          medsos.map((v, i) => {
            return (
              v.active && (
                <Link href={v.link} key={i}>
                  <a
                    target="_blank"
                    className={`${v.color} w-12 px-1 py-2 cursor-pointer hover:scale-105 hover:opacity-75`}
                  >
                    <svg
